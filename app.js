document.addEventListener('DOMContentLoaded', () => {
  ...
  function playMusicOnInteraction() {
    backgroundMusic.play().catch(err => {
      console.warn('Autoplay blocked. Playing music after user interaction.');
    });
  ...
  document.addEventListener('scroll', playMusicOnInteraction);

  // Automatically start music on desktop (if autoplay isn't blocked)
...
function isMobileDevice() {
  return /android|bb\d+|meego|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) 
...
function playMusic() {
  ...
  // Remove the black background class from the body
